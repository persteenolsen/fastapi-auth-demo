...
# 14-06-2026 - The migration should be done only by Alembic
...
app = FastAPI(
    ...
    description="20-09-2026 - FastAPI authentication service using JWT with PostgreSQL for data persistence and Alembic for database migrations. Demo credentials: testuser / admin",
    version="0.0.1",
